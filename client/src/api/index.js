...
export const getUsers = () => API.get('/api/users/v1/admin/getUsers', accessHeader)

export const adminDeleteUser = (formData) => API.delete('/api/users/v1/admin/deleteUser', {headers: accessHeader.headers, data: formData})